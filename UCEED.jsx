...
import { CheckCircle, Circle, Target, TrendingUp, Award, Calendar, Clock, Zap, Star, BarChart3, PlusCircle, X } from 'lucide-react';
...
const UCEEDPreparationTracker = () => {
  ...
  const removeMockTest = (index) => {
    setMockTests(mockTests.filter((_, i) => i !== index));
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Add Test Button - Show when no tests exist */}
        {mockTests.length === 0 && (
